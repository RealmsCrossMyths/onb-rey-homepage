...
<tileset version="1.8" tiledversion="1.8.0" name="Warp Decor - Page" tilewidth="64" tileheight="32" tilecount="5" columns="5" objectalignment="top">
 <grid orientation="isometric" width="64" height="32"/>
 <image source="page.png" width="320" height="32"/>
 <tile id="0">
  <animation>
