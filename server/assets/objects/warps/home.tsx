...
<tileset version="1.8" tiledversion="1.8.0" name="Warp - Home" tilewidth="64" tileheight="32" tilecount="5" columns="5" objectalignment="bottom">
 <grid orientation="isometric" width="64" height="32"/>
 <image source="home.png" width="320" height="32"/>
 <tile id="0">
  <objectgroup draworder="index" id="2">
   <object id="8" x="10" y="10" width="10" height="10">
    <ellipse/>
   </object>
  </objectgroup>
  <animation>
